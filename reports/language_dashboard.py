...
class LanguageDashboard(BaseReportV2):
    ...
    def __init__(self, db_manager, **kwargs):
        ...
        self.available_filters = ['language', 'country', 'survey_type']
    ...
    def get_sheet_names(self) -> Dict[str, str]:
        return {
            'surveys_summary': '1. All Language Surveys',
            'background_summary': '2. Language Background',
            'usage_summary': '3. Language Usage',
            'vitality_summary': '4. Language Vitality',
            'key_insights': '5. Key Insights'
        }
