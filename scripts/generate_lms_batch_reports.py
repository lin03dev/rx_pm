...
from utils.excel_writer import get_excel_writer
...
def main():
    ...
    for idx, batch in batches_df.iterrows():
        ...
        try:
            report = BatchDetailedReport(db_manager, batch_id=batch_id)
            ...
            if 'error' not in report_data:
                ...
                # Use the conditional Excel writer
                excel_writer.save_report(output_path, report_data, report.get_sheet_names())
